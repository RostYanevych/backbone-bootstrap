...
], function(app, UsersCollection, UsersPageTpl){

    var UsersView = Backbone.View.extend({

        initialize: function () {
            _.bindAll(this, 'render');
console.debug('initialize UsersView', UsersCollection);
            this.users = new UsersCollection();
            //here we should load Users list
        },
...
*/
        ...
        render:function () {
console.debug('render UsersView', this.users.url());
            var self = this;
